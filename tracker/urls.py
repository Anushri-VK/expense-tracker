...
from tracker.views import dashboard,get_all_wallet,get_all_expense,get_all_income,create_wallet,create_expense,create_income,delete_wallet,delete_expense,delete_income,edit_wallet,edit_expense,edit_income
